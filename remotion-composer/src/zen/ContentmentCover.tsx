...
const handle = delayRender("content-cover-fonts", { timeoutInMilliseconds: 120000 });
Promise.all([
...
export const ContentmentCover: React.FC = () => (
  <AbsoluteFill style={{ backgroundColor: "#05080e" }}>
    <Img src={staticFile("zen/scenes/cover_content_bg.jpg")} style={{ width: "100%", height: "100%", objectFit: "cover" }} />
