...
const handle = delayRender("calm-cover-fonts", { timeoutInMilliseconds: 120000 });
Promise.all([
...
export const CalmCover: React.FC = () => (
  <AbsoluteFill style={{ backgroundColor: "#05080e" }}>
    <Img src={staticFile("zen/scenes/cover_calm_bg.jpg")} style={{ width: "100%", height: "100%", objectFit: "cover" }} />
